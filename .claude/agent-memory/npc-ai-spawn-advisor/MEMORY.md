...
- [na36-extractor-mesh-actor-gap.md](na36-extractor-mesh-actor-gap.md) — NA36 widened the extractor to InterpActor/KActor/FracturedStaticMeshActor; did NOT explain Harset's raised-platform telemetry gap or spawn 308 (both need a live `.location` reading, not more extractor work)
