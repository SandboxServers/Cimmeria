...
**How to apply:** check startup ordering before relying on spawn-time lookups; keep an NPC at its slot on the peek-point LoS rule (NA23), not an exemption, when touching fight.rs attack gates. Related: [[leash-and-fight-exit-traps]], [[harset-zone-evidence]].
