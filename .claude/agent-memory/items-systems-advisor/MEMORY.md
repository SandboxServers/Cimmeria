...
- [items_event_sets_dual_purpose.md](items_event_sets_dual_purpose.md) — items_event_sets event_id 6/7 (melee/ranged) IS live for weapon auto-attack binding; only event_id 5 is dead — don't call the whole table legacy
