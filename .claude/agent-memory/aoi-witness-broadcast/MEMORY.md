...
- [project_na37_two_client_wire_visibility.md](project_na37_two_client_wire_visibility.md) — NA37 r1: AoI works over lossless wire. NA37 r2 (chaos): confirmed defect -- receive_packet's RX-window ordering gate is dead code; lost+retransmitted CREATE_ENTITY lets later updates arrive first
