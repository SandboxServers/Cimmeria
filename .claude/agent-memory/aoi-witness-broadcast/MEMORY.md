...
- [project_na37_two_client_wire_visibility.md](project_na37_two_client_wire_visibility.md) — NA37 real two-wire-client Castle test: AoI introduction confirmed working over the wire (both orders/GM status); entities_dir CWD trap + LoopbackPeer-as-real-client reuse pattern
