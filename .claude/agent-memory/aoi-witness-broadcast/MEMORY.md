...
- [project_na37_two_client_wire_visibility.md](project_na37_two_client_wire_visibility.md) — NA37 r1: AoI works over lossless wire. NA37 r2 (chaos) "ordering defect" was harness-only, superseded by NA38 (client orders reliable packets itself)
