...
See [navmesh-containment-modes.md](navmesh-containment-modes.md) for the per-world `navmesh_mode` side of this, and [navmesh-recast-and-castle-topology.md](navmesh-recast-and-castle-topology.md) for mesh generation.
