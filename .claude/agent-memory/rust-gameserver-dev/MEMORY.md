...
- [log-filter-parity-traps.md](log-filter-parity-traps.md) — `EnvFilter::new` silently drops a bad directive; runtime-target filter tests; custom targets leave their log file; open DEBUG-target gaps.
