...
- [Mercury Section 2 Track B evidence](mercury-section-2-track-b-evidence.md) — **[PROMOTE → spec.protocol.mercury-wire-format §2 — all subsections]** — R11–R15 behavior, 46 ClientInterface handler RTTI names, 37+ error strings catalogued, protocol_digest chain confirmed, retry cap = 5.0f not 20, R13 sweep-timer claim UNCONFIRMED. **Investigation 6 (added 2026-05-15) closes Gap B: protocol_digest is SHA-1 uppercase hex, 40 chars, stored at ServerConnection+0x130.**
