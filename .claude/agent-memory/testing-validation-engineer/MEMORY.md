...
- [project_legacy_command_parity_review_pattern.md](project_legacy_command_parity_review_pattern.md) — legacy-command-parity packets skip fmt/clippy by protocol (run them yourself); acceptance lines often list multiple response classes, only some tested
