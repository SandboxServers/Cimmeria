...
**Total new structure** *(assumes `spawner.rs` is also refactored as part of the
optional follow-up — without that step, max file remains 915L from spawner.rs):*
...
- **Zero files > 400L** (currently 2) — only after spawner.rs is also split
