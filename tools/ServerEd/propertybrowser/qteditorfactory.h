...
public:
    ...
    QtProperty * propertyFromWidget(class QSpinBox * widget);
    QSpinBox * widgetFromProperty(QtProperty * widget);
...
class QtDatabaseWrapperWidget : public QWidget
{
    Q_OBJECT
public:
    QtDatabaseWrapperWidget(QWidget *parent = 0);
    ~QtDatabaseWrapperWidget();

    void setPushButton(class QWidget * button);
    void setLabel(class QLabel * label);
    void setEditBox(QWidget * button);
...
class QtDatabaseSpinBoxFactory : public QtSpinBoxFactory
{
    Q_OBJECT
public:
    QtDatabaseSpinBoxFactory(QObject *parent = 0);
    ~QtDatabaseSpinBoxFactory();

public slots:
    void dbNameUpdated(QtProperty * property, QString name);
...
private:
    Q_DISABLE_COPY(QtDatabaseSpinBoxFactory)
};
...
private:
    ...
    Q_PRIVATE_SLOT(d_func(), void slotPropertyChanged(QtProperty *, qlonglong))
    Q_PRIVATE_SLOT(d_func(), void slotEnumNamesChanged(QtProperty *,
                        const QStringList &))
    Q_PRIVATE_SLOT(d_func(), void slotEnumIconsChanged(QtProperty *,
                        const QMap<int, QIcon> &))
    Q_PRIVATE_SLOT(d_func(), void slotSetValueCompat(int))
    Q_PRIVATE_SLOT(d_func(), void slotSetValue(qlonglong))
    Q_PRIVATE_SLOT(d_func(), void slotEditorDestroyed(QObject *))
};
