    ...
    std::string & columnName)
{
    ...
    default:
        // Treat unknown types (custom enums, composites, etc.) as strings.
        // PostgreSQL assigns dynamic OIDs to user-defined types; reading
        // them as text is safe because libpq returns their text representation.
        type = dt_string;
        break;
    }
