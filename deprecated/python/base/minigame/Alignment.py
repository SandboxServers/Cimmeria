...
class Alignment(Atrea.Minigame):
	...
	def started(self):
		self.minigameLevel = floor((self.techCompetency - 1) / 5)
		self.moveMode = 0
		self.goalsAreMet = True
		self.initialized = True
		self.consumablesUsed = False
		self.consumableCheatBonus = False
		self.hintIndex = 0
		self.hintTimerPause = False
		self.stopTimerMatch = False
		self.addTimerMatch = False
		self.addTimerMatchMove = False
		self.abilityAddTime = False
		self.powerUpAddTime = False
		self.currentScores = []
		self.cascadeCount = 0
		self.cipherScore = 0
		self.cipherTotal = 3
		self.protocolScore = 0
		self.protocolTotal = 999999
		self.codeScore = 0
		self.codeTotal = 9
		self.forceScore = 0
		self.forceTotal = 12
		...
		self.achievementTotal = 999999
		self.experienceScore = 0
		self.experienceTotal = 999999
		self.cashScore = 0
		self.cashTotal = 999999
		self.dropDirection = [0, 1, 2, 3, 4, 5]
		self.dropIndex = 0

		self.hintLastTime = self.timeRemaining
		self.hintTimer = 5
		self.sendFullGameState()
