...
CREATE INDEX idx_login_audit_event_time ON login_audit (event_time DESC);
CREATE INDEX idx_login_audit_account_time ON login_audit (account_name, event_time DESC);
