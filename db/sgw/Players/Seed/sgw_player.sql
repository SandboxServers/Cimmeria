...
--
-- training_points follows the v2 economy (D-AT02, PROJECT FINAL v2, not
-- retail data): 1 point at level 1 plus 1 per level, so an unspent
-- character holds exactly `level` points. Every seeded character is level 1.
--
