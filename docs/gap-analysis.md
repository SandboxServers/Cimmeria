...
| Ability tree sync | CW | -- | base/world_entry/methods/player_load | 3 trees per archetype. **Seed replaced 2026-09-26 (AT-05):** the Soldier/Commando stub became the FINAL v2 import, 439 nodes across 7 archetypes (Jaffa has none, D-AT04), pinned by `ability_tree::tests::seed_live_db`. No in-client pass with the new trees yet: branches now reach 25 nodes and levels up to 50 |
