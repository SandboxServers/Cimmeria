...
| Ability tree sync | CW | -- | ability_tree/tree_info.rs, base/world_entry/methods/player_load | 3 trees per archetype, built from the shared `AbilityTreeCatalog` (AT-02); no Rust fallback tree |
