...
**Code:** [`crates/cell-cover/src/cell/cover/`](../../crates/cell-cover/src/cell/cover/) (the `cimmeria-cell-cover` crate: decision, reservation, scoring, peek point), [`crates/services/src/cell/cover/stance.rs`](../../crates/services/src/cell/cover/stance.rs) (the spawn hold, Cover Stance and the shared release; it stays in `cimmeria-services` until the world crate is split out), [`space_manager/cover_sight.rs`](../../crates/services/src/cell/space_manager/cover_sight.rs) (an NPC's line of sight from its slot), [`npc_ai/fight_cover.rs`](../../crates/services/src/cell/service/npc_ai/fight_cover.rs) (the fight tick's cover step), [`effects/cover_stance.rs`](../../crates/services/src/cell/effects/cover_stance.rs) (the Cover Stance scripts).
