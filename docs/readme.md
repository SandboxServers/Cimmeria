...
| [session-bootstrap.md](architecture/session-bootstrap.md) | Stage 0 deterministic session bootstrap: opt-in server-side autoplay (two gates, account-ownership validation) and the `cimmeria-server-harness` spawn/readiness/reap contract | Complete |
