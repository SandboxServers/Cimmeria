...
**Status:** Writing (2026-09-17, branch `harset/H11`, base `3c1fed6c`; the spec spreadsheet is not in the repository, so values not recoverable from the audit or seed are recorded as INFERRED). **Scope title:** Entity templates for the missing Harset NPCs and props. **Depends:** none. **Decision:** D-H16, D-H17. **Advisor:** npc-ai-spawn-advisor; combat-systems-advisor for ability sets.
