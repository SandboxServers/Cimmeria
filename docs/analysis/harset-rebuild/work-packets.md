...
**Status:** Writing (2026-09-17, branch `harset/H02`, base `3c1fed6c`; the ring-arrival navmesh check is deferred to a follow-up once H01's helper lands). **Scope title:** Ring FSM timeouts and disconnect cleanup. **Depends:** none. **Advisor:** movement-teleport-advisor; aoi-witness-broadcast for the re-show on abort.
