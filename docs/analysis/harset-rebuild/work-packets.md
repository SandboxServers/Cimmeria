...
**Status:** Writing (2026-09-17, branch `harset/H01`, worktree isolated, base `3c1fed6c`). **Scope title:** Safe gate arrival, stargate region flag, DHD interaction. **Depends:** none. **Decision:** D-H07, D-H08. **Advisor:** movement-teleport-advisor; server-authority-enforcer for the flag handler.
