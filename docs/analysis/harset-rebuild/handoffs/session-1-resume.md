...
4. Castle CA10 = PR #663 (splits `gate_travel.rs` into a dir, owns stargate region routing); whichever merges second carries H01's single `validate_gate_arrival` call into the placement sites.
