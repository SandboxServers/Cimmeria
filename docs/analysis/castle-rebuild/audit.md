...
| Dialog 5861 is a drop-in Jaffa equivalent of 2573 | 2573 carries an Accept button on every screen; 5861 has Accept on screens 96782-96786 only and none on 96787-96789. | D-CA13 uses it and files the UI gap. |
