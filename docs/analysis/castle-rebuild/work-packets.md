...
**Status:** Writing (2026-09-17; combined with CA03 in worktree `castle-m701`, branch `castle/m701-gerschon-copplemann`; C09 reassigned in `694f17a7`, D-CA03/D-CA13 defaults adopted; seed file `castle_701_chains.sql` per D-CA17). **Scope title:** Castle arrival and Gerschon handoff (Cellblock C09, moved here). **Depends:** Cellblock C04 (letter 1360 persistence) for one assertion only. **Advisor:** mission-systems-advisor, movement-teleport-advisor.
...
**Status:** Writing (2026-09-17; worktree `castle-ca02`, branch `castle/ca02-nullable-dialog-bind`; D-CA03 default adopted, wire-evidence step first). **Scope title:** Interaction-only dialog-set bind (defect B3). **Depends:** none. **Advisor:** mission-systems-advisor; aoi-witness-broadcast for the client push.
...
**Status:** Writing (2026-09-17; with CA01 in worktree `castle-m701`; D-CA02 option A, D-CA04, D-CA05 defaults adopted). **Scope title:** Mission 701 body, steps 2399 through 2421. **Advisor:** mission-systems-advisor, minigame-systems-advisor.
...
**Status:** Writing (2026-09-17; worktree `castle-ca04`, branch `castle/ca04-minigame-hardening`; replay file `chain_replay_tests/livewire_pairs.rs`). **Scope title:** Minigame session hardening and Livewire replay coverage (defects B4, B5). **Depends:** none. **Advisor:** minigame-systems-advisor, testing-validation-engineer.
...
**Status:** Writing (2026-09-17; with CA07 in worktree `castle-m702`, branch `castle/m702-704-zuritska-romney`; D-CA17's file split removes the CA03 file dependency, CA05's tags are contracts; seed file `castle_702_704_chains.sql`). **Scope title:** Missions 702 and 703. **Advisor:** mission-systems-advisor, combat-systems-advisor (Romney fight), items-systems-advisor.
...
**Status:** Writing (2026-09-17; with CA06 in worktree `castle-m702`; GC1b-0 merged in PR #646, D-CA07/D-CA08/D-CA09 defaults adopted). **Scope title:** Mission 704, the Communications room. **Advisor:** npc-ai-spawn-advisor, mission-systems-advisor, minigame-systems-advisor.
...
**Status:** Ready (2026-09-17; D-CA17's file split removes the CA01 dependency; dispatched together with CA09 once CA10's trigger branch is pushed; seed file `castle_706_708_chains.sql`). **Scope title:** Mission 706, the Throne Room. **Advisor:** mission-systems-advisor.
...
**Status:** Writing (2026-09-17; worktree `castle-ca10`, branch `castle/ca10-stargate-events`; scope widened by D-CA18 to add the `stargate_dialed`/`stargate_crossed` triggers; passage-side emit lives in one function in `cell/gate_travel.rs` that Harset H01's flag-2 entry will call). **Scope title:** Stargate open and cross events (defect B6; D-CA10). **Depends:** Cellblock C08a for the 4 s deferral if implemented as a content action, otherwise a `tokio` timer in the dial handler. **Advisor:** aoi-witness-broadcast, movement-teleport-advisor, game-archaeology-specialist (order verification).
