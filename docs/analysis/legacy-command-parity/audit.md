...
| `.summon` | No | `name`; O, selected-or-caller destination (legacy) — **ours: always the caller**, selection ignored (owner decision 2026-09-20, see [worknotes/p46.md](worknotes/p46.md) §6) | absent | N/E: native 161 is numeric/same-space. Named player moves to the caller's existing instance and position. | [travel](../../../crates/services/src/cell/cell_methods/gm/travel.rs) | [G05](work-packets.md#g05) |
...
| `.net_timer` | Yes | `id type [totalTime=1] [secondaryId=0]`; S | partial | E: 17 instead of 21 bytes, missing secondaryId; caller used as source, completion equals duration. Def Type is INT8. | [net](../../../crates/services/src/cell/console/net.rs) | [P38](work-packets.md#p38) |
