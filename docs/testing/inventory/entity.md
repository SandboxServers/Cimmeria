...
|---|---|---|---|---|---|
| [new_manager_is_empty](../../../crates/entity/src/abilities/manager.rs#L370) | unit | Abilities | 2026-03-06 | Asserts equality on `mgr.known_count()` |  |
| [add_and_check_abilities](../../../crates/entity/src/abilities/manager.rs#L378) | unit | Abilities | 2026-03-06 | Asserts on `mgr.has_ability(597)` |  |
| [remove_ability](../../../crates/entity/src/abilities/manager.rs#L389) | unit | Abilities | 2026-03-06 | Asserts equality on `mgr.known_count()` |  |
| [with_abilities_constructor](../../../crates/entity/src/abilities/manager.rs#L398) | unit | Abilities | 2026-03-06 | Asserts equality on `mgr.known_count()` |  |
| [cooldown_tracking](../../../crates/entity/src/abilities/manager.rs#L407) | unit | Abilities | 2026-03-06 | Asserts on `!mgr.is_on_cooldown(597)` |  |
| [can_use_ability_checks](../../../crates/entity/src/abilities/manager.rs#L422) | unit | Abilities | 2026-03-06 | Asserts on `mgr.can_use_ability(&ability).is_ok()` |  |
| [can_use_ability_cooldown_check](../../../crates/entity/src/abilities/manager.rs#L439) | unit | Abilities | 2026-03-06 | Asserts equality on `mgr.can_use_ability(&ability).unwrap_err()` |  |
| [next_effect_id_increments](../../../crates/entity/src/abilities/manager.rs#L450) | unit | Abilities | 2026-03-06 | Asserts equality on `mgr.next_effect_id()` |  |
| [serialize_known_abilities](../../../crates/entity/src/abilities/manager.rs#L458) | unit | Abilities | 2026-03-06 | Asserts equality on `count` |  |
| [ability_tree_empty](../../../crates/entity/src/abilities/defs.rs#L323) | unit | Abilities | 2026-03-06 | Asserts equality on `data.len()` |  |
| [ability_tree_with_data](../../../crates/entity/src/abilities/defs.rs#L341) | unit | Abilities | 2026-03-06 | Asserts equality on `data.len()` |  |
| [serialize_timer_update_format](../../../crates/entity/src/abilities/wire.rs#L77) | unit | Abilities | 2026-03-06 | Asserts equality on `data.len()` |  |
| [serialize_effect_results_empty](../../../crates/entity/src/abilities/wire.rs#L86) | unit | Abilities | 2026-03-06 | Asserts equality on `data.len()` |  |
| [serialize_effect_results_with_stats](../../../crates/entity/src/abilities/wire.rs#L95) | unit | Abilities | 2026-03-06 | Asserts equality on `data.len()` |  |
| [client_effect_result_serialize](../../../crates/entity/src/abilities/wire.rs#L112) | unit | Abilities | 2026-03-06 | Asserts equality on `buf.len()` |  |
| [cleanup_expired_removes_old](../../../crates/entity/src/abilities/manager.rs#L603) | unit | Abilities | 2026-03-06 | Asserts equality on `mgr.ability_cooldowns.len()` |  |
| [first_known_ability_returns_some](../../../crates/entity/src/abilities/manager.rs#L621) | unit | Abilities | 2026-03-17 | Asserts on `first.is_some()` |  |
| [first_known_ability_returns_none_when_empty](../../../crates/entity/src/abilities/manager.rs#L630) | unit | Abilities | 2026-03-17 | Asserts on `mgr.first_known_ability().is_none()` |  |
| [first_known_ability_single_element](../../../crates/entity/src/abilities/manager.rs#L636) | unit | Abilities | 2026-03-17 | Asserts equality on `mgr.first_known_ability()` |  |
...
| [new_entity_defaults](../../../crates/entity/src/cell_entity/tests.rs#L9) | unit | Cell Entity | 2026-05-02 | Asserts equality on `entity.entity_id` |  |
| [set_and_get_position](../../../crates/entity/src/cell_entity/tests.rs#L23) | unit | Cell Entity | 2026-05-02 | Asserts equality on `*entity.get_position()` |  |
| [add_and_remove_witness](../../../crates/entity/src/cell_entity/tests.rs#L31) | unit | Cell Entity | 2026-05-02 | Asserts equality on `entity.get_witnesses().len()` |  |
| [duplicate_witness_is_idempotent](../../../crates/entity/src/cell_entity/tests.rs#L44) | unit | Cell Entity | 2026-05-02 | Asserts equality on `entity.get_witnesses().len()` |  |
| [remove_absent_witness_is_noop](../../../crates/entity/src/cell_entity/tests.rs#L52) | unit | Cell Entity | 2026-05-02 | Asserts on `entity.get_witnesses().is_empty()` |  |
| [is_in_aoi_within_radius](../../../crates/entity/src/cell_entity/tests.rs#L59) | unit | Cell Entity | 2026-05-02 | Asserts on `entity.is_in_aoi(&nearby)` |  |
| [is_in_aoi_outside_radius](../../../crates/entity/src/cell_entity/tests.rs#L66) | unit | Cell Entity | 2026-05-02 | Asserts on `!entity.is_in_aoi(&far_away)` |  |
| [is_in_aoi_at_exact_boundary](../../../crates/entity/src/cell_entity/tests.rs#L73) | unit | Cell Entity | 2026-05-02 | Asserts on `entity.is_in_aoi(&boundary)` |  |
| [new_entity_ammo_defaults_empty](../../../crates/entity/src/cell_entity/tests.rs#L84) | unit | Cell Entity | 2026-05-02 | Asserts equality on `entity.active_ammo()` |  |
| [new_entity_ai_state_defaults_idle](../../../crates/entity/src/cell_entity/tests.rs#L96) | unit | Cell Entity | 2026-05-02 | Asserts equality on `entity.ai_state` |  |
| [new_entity_saved_missions_loaded_false](../../../crates/entity/src/cell_entity/tests.rs#L105) | unit | Cell Entity | 2026-05-02 | Asserts on `!entity.saved_missions_loaded` |  |
| [ai_state_equality](../../../crates/entity/src/cell_entity/tests.rs#L111) | unit | Cell Entity | 2026-05-02 | Asserts equality on `AiState::Idle` |  |
| [threat_list_operations](../../../crates/entity/src/cell_entity/tests.rs#L121) | unit | Cell Entity | 2026-05-02 | Asserts equality on `entity.threat_list.len()` |  |
| [spawn_position_stores_and_retrieves](../../../crates/entity/src/cell_entity/tests.rs#L145) | unit | Cell Entity | 2026-05-02 | Asserts on `entity.spawn_position.is_none()` |  |
| [active_ammo_helpers_with_no_item_return_zero](../../../crates/entity/src/cell_entity/tests.rs#L168) | unit | Cell Entity | 2026-05-02 | Asserts equality on `entity.active_ammo()` |  |
| [active_ammo_helpers_read_from_active_slot](../../../crates/entity/src/cell_entity/tests.rs#L176) | unit | Cell Entity | 2026-05-02 | Active ammo helpers read from active slot |  |
| [set_slot_ammo_clamps_and_marks_dirty](../../../crates/entity/src/cell_entity/tests.rs#L211) | unit | Cell Entity | 2026-05-02 | Asserts equality on `result` |  |
| [set_slot_ammo_unequipped_returns_none](../../../crates/entity/src/cell_entity/tests.rs#L233) | unit | Cell Entity | 2026-05-02 | Asserts equality on `result` |  |
| [refill_active_slot_fills_to_clip_size](../../../crates/entity/src/cell_entity/tests.rs#L241) | unit | Cell Entity | 2026-05-02 | Refill active slot fills to clip size |  |
| [refill_active_slot_unequipped_returns_none](../../../crates/entity/src/cell_entity/tests.rs#L264) | unit | Cell Entity | 2026-05-02 | Asserts equality on `result` |  |
...
| [new_inventory_has_default_bags](../../../crates/entity/src/inventory.rs#L218) | unit | Inventory | 2026-03-06 | Asserts equality on `inv.bags.len()` |  |
| [empty_inventory_serialize_bag_info](../../../crates/entity/src/inventory.rs#L228) | unit | Inventory | 2026-03-06 | Asserts equality on `count as usize` |  |
| [empty_inventory_serialize_items](../../../crates/entity/src/inventory.rs#L238) | unit | Inventory | 2026-03-06 | Asserts equality on `count` |  |
| [serialize_cash](../../../crates/entity/src/inventory.rs#L247) | unit | Inventory | 2026-03-06 | Asserts equality on `i32::from_le_bytes([data[0], data[1], data[2], data[3]])` |  |
| [add_and_serialize_item](../../../crates/entity/src/inventory.rs#L257) | unit | Inventory | 2026-03-06 | Add and serialize item |  |
| [inv_item_serialize_with_ammo](../../../crates/entity/src/inventory.rs#L285) | unit | Inventory | 2026-03-06 | Inv item serialize with ammo |  |
| [bag_ids_match_python](../../../crates/entity/src/inventory.rs#L312) | unit | Inventory | 2026-03-06 | Asserts equality on `INV_MAIN` |  |
...
| [player_controller_no_update_returns_none](../../../crates/entity/src/movement.rs#L206) | unit | Movement | 2026-03-03 | Asserts on `ctrl.update(0.016).is_none()` |  |
| [player_controller_apply_and_update](../../../crates/entity/src/movement.rs#L212) | unit | Movement | 2026-03-03 | Asserts equality on `pos` |  |
| [player_controller_update_consumed](../../../crates/entity/src/movement.rs#L220) | unit | Movement | 2026-03-03 | Asserts on `ctrl.update(0.016).is_none()` |  |
| [player_controller_never_completes](../../../crates/entity/src/movement.rs#L228) | unit | Movement | 2026-03-03 | Asserts on `!ctrl.is_complete()` |  |
| [waypoint_controller_moves_toward_target](../../../crates/entity/src/movement.rs#L293) | unit | Movement | 2026-03-03 | Asserts on `(pos.x - 5.0).abs() < 0.01` |  |
| [waypoint_controller_reaches_end](../../../crates/entity/src/movement.rs#L304) | unit | Movement | 2026-03-03 | Asserts on `ctrl.is_complete()` |  |
| [waypoint_controller_multiple_waypoints](../../../crates/entity/src/movement.rs#L314) | unit | Movement | 2026-03-03 | Asserts on `!ctrl.is_complete()` |  |
| [waypoint_controller_returns_none_when_complete](../../../crates/entity/src/movement.rs#L332) | unit | Movement | 2026-03-03 | Asserts on `ctrl.update(1.0).is_none()` |  |
| [waypoint_controller_empty_path_panics](../../../crates/entity/src/movement.rs#L341) | unit | Movement | 2026-03-03 | Waypoint controller empty path panics | smell: no_assert_or_question_mark |
| [waypoint_controller_position](../../../crates/entity/src/movement.rs#L346) | unit | Movement | 2026-03-03 | Asserts equality on `ctrl.position()` |  |
| [load_castle_cellblock_nav](../../../crates/entity/src/navigation/tests.rs#L9) | unit | Navigation | 2026-03-22 | Asserts on `mesh.agent_height > 0.0` |  |
| [load_and_pathfind_castle_cellblock](../../../crates/entity/src/navigation/tests.rs#L28) | unit | Navigation | 2026-03-24 | Asserts on `path_result.is_some()` |  |
| [load_and_raycast_castle_cellblock](../../../crates/entity/src/navigation/tests.rs#L51) | unit | Navigation | 2026-03-24 | Load and raycast castle cellblock | smell: no_assert_or_question_mark |
| [load_and_height_query](../../../crates/entity/src/navigation/tests.rs#L334) | unit | Navigation | 2026-03-24 | Asserts on `height.is_some()` |  |
