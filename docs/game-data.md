...
- **Organizations/Guilds** — server-side handlers exist at [crates/services/src/cell/cell_methods/organization.rs](../crates/services/src/cell/cell_methods/organization.rs) and [client_methods/organization.rs](../crates/wire/src/cell/client_methods/organization.rs).
- **Mail system** — handlers exist at [crates/services/src/base/world_entry/methods/mail/](../crates/services/src/base/world_entry/methods/mail/), [cell/cell_methods/mail.rs](../crates/services/src/cell/cell_methods/mail.rs), and [cell/client_methods/mail.rs](../crates/wire/src/cell/client_methods/mail.rs).
...
- **Cover nodes** — [db/resources/AI/Seed/cover_nodes.sql](../db/resources/AI/Seed/cover_nodes.sql) and [cover_sets.sql](../db/resources/AI/Seed/cover_sets.sql) carry world-space cover for Castle_CellBlock and Castle, extracted from the maps' `.umap` chunks and scoped per world ([engine/cover-extraction.md](engine/cover-extraction.md)); other worlds have none yet, and the content engine exposes `player_entered_cover` / `player_left_cover` / `player_in_cover_duration` / `npc_flanked` / `player_flanked_npc` triggers on top of them.
