...
- **Auction house / Black Market** — implemented under [crates/services/src/base/black_market/](../crates/services/src/base/black_market/) (create, bid, cancel, search, expiry sweep, plus tests), reachable in-world through the content engine's `open_black_market` action.
