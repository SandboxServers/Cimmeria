...
- **Organizations/Guilds** — server-side handlers exist at [crates/services/src/cell/cell_methods/organization.rs](../crates/services/src/cell/cell_methods/organization.rs) and [client_methods/organization.rs](../crates/services/src/cell/client_methods/organization.rs).
