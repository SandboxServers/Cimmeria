    ...
    match archetype_id {
        1 => AbilityTreeData {
            ...
            trees: [
                // Tree 0 (29 abilities)
                vec![
                    597, 603, 604, 610, 611, 616, 617, 621, 622, 623, 625, 627, 641, 643, 645, 648,
                    650, 652, 661, 662, 663, 666, 667, 668, 672, 675, 677, 679, 680,
                ],
                // Tree 1 (28 abilities)
                vec![
                    598, 599, 605, 606, 612, 613, 618, 619, 624, 626, 628, 629, 642, 644, 646, 647,
                    649, 651, 653, 654, 664, 665, 669, 670, 673, 674, 676, 678,
                ],
                // Tree 2 (27 abilities)
                vec![
                    600, 601, 602, 607, 608, 609, 614, 615, 620, 630, 631, 655, 656, 657, 658, 659,
                    660, 671, 681, 682, 683, 684, 685, 686, 687, 688, 689,
                ],
            ],
        },
        2 => AbilityTreeData {
            ...
            trees: [
                // Tree 0 (28 abilities)
                vec![
                    700, 706, 707, 713, 714, 720, 721, 726, 727, 731, 732, 733, 735, 736, 750, 751,
                    753, 755, 757, 765, 766, 770, 771, 774, 775, 778, 780, 781,
                ],
                // Tree 1 (30 abilities)
                vec![
                    701, 702, 708, 709, 715, 716, 722, 723, 728, 729, 734, 737, 738, 739, 752, 754,
                    756, 758, 759, 767, 768, 769, 772, 773, 776, 777, 779, 782, 783, 784,
                ],
                // Tree 2 (27 abilities)
                vec![
                    703, 704, 705, 710, 711, 712, 717, 718, 719, 724, 725, 730, 740, 741, 760, 761,
                    762, 763, 764, 785, 786, 787, 788, 789, 790, 791, 792,
                ],
            ],
        },
