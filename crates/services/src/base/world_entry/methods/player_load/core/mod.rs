//! Player-load core loaders, split along natural seams (issue #529):
//! - [`player_data`] — `query_player_load_data`, the mapLoaded loader.
//! - [`inventory_items`] — `query_inventory_items`, the inventory row loader.
//!
