...
///
/// This is the **option (c)** path from the security review on
/// PR #438. Option (a) "send no InvItem payload" is wire-incompatible
...
mod tests {
    ...
    /// Wire-level regression guard for the info-asymmetry fix on
    /// PR #438.
    ///
    ...
    fn on_trade_state_stub_invitem_carries_sentinel_not_lying_values() {
        use cimmeria_entity::trade::{serialize_on_trade_state, ETRADELOCKSTATE_NONE};
