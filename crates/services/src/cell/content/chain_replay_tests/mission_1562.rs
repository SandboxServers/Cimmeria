//! Mission 1562 (`db/resources/Content/Seed/sgc_w1_chains.sql`):
//! `dialog_choice('5365')` accepts mission 1562, gated by
//! `mission_status(1562) = 'not_active'`. Without that gate, every
//! dialog re-display re-accepts the mission and resets progress.
