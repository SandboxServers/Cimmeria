//! Mission and item cooked-data override tests: the `compute_metadata_bump`
//! and `compute_item_metadata_bump` helpers, the `apply_mission_overrides` /
//! `apply_item_overrides` in-memory mutation paths, and the
//! `overridden_elements` accessor.
//!
//! Split out of the monolithic `resources/tests.rs` (issue #529). The dialog
//! half moved to [`super::dialog_overrides`] when patch-mode overrides pushed
//! this file past the 700-line cap.
